...
select compare_new_old_full('osm_old.settlements','osm.settlements', 100,'');
select compare_new_old_full_list('osm_old.settlements','osm.settlements', 100,'');
...
select compare_new_old_full('osm_old.island','osm.island', 100,'');
select compare_new_old_full_list('osm_old.island','osm.island', 100,'');
...
select compare_new_old_full('osm_old.water','osm.water', 50,'');
select compare_new_old_full_list('osm_old.water','osm.water', 50,'');
