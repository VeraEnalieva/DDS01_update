...
create table public.planet_osm_line_dc as (select * from public.planet_osm_line);
DO $$
    BEGIN
...
create table public.planet_osm_roads_dc as (select * from public.planet_osm_roads);
DO $$
	BEGIN
